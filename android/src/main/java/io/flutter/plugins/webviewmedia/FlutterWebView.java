...
package io.flutter.plugins.webviewmedia;
...
public class FlutterWebView implements PlatformView, MethodCallHandler {
  ...
  FlutterWebView(
    ...
    if (params.containsKey("initialData")) {
      Map<String, Object> initialData = (Map<String, Object>) params.get("initialData");
      String data = (String) initialData.get("data");
      String baseUrl = (String) initialData.get("baseUrl");
      String mimeType = (String) initialData.get("mimeType");
      String encoding = (String) initialData.get("encoding");
      String historyUrl = (String) initialData.get("historyUrl");
